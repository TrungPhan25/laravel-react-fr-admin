            ...
            <div className="tab-content" id="myTabContent">
                ...
                <div className="form-group mb-3">
                  ...
                  >
                    ...
                    {categorylist.map((item) => {
                      return (
                        <option value={item.categorySlug} key={item.id}>
                          {item.display}
                        </option>
                      );
                    })}
              ...
              >
                <div className="row">
                  ...
                  <div>
                    <img
                      src={`http://localhost/laravel-react-backend-gayquy/public/${pricture}`}
                      width="100px"
                      alt={pricture}
                    />
                  </div>
                  ...
                  <div>
                    <img
                      src={`http://localhost/laravel-react-backend-gayquy/public/${pricture2}`}
                      width="100px"
                      alt={pricture2}
                    />
                  </div>
